...
<html lang="en">
<head>
	<title><?php echo $getprofile['profile_name']; ?></title>
	...
	<link href="css-js/blog-sidebar/css/styles.css" rel="stylesheet">

	<link href="css-js/blog-sidebar/css/responsive.css" rel="stylesheet">
		...
		<div class="overlay-content1">
				...
				<?php
					...
					while ($getpost1=$searchpost1->fetch(PDO::FETCH_ASSOC)) { ?>
						...
						<li><a style="color:white; font-size:20px;" href="contents/content.php?post_id=<?php echo $getpost1['post_id']; ?>"><?php echo $getpost1['post_title']; ?></a></li><br>
